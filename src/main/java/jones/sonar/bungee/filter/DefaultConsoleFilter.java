...
public final class DefaultConsoleFilter {
    protected DefaultConsoleFilter() {
        SonarBungee.INSTANCE.proxy.getLogger().setFilter(record -> ((!(record.getSourceClassName().equals("net.md_5.bungee.connection.InitialHandler")
                || (record.getSourceClassName().equals("net.md_5.bungee.log.BungeeLogger") && record.getMessage().contains(" InitialHandler ")))
